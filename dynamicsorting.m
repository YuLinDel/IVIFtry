...
% l1=legend('t1:weight')
legend('Sorting at time t1 is:A1>A4>A5>A2>A3>A7>A6','Sorting at time t2 is为:A1>A4>A2>A5>A3>A7>A6','Sorting at time t3 is:A1>A4>A2>A5>A3>A7>A6','The final comprehensive ranking is:A1>A4>A2>A5>A3>A7>A6');
